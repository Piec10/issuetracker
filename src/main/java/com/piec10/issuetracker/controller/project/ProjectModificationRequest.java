...
public abstract class ProjectModificationRequest implements ModificationRequest {

    protected ProjectService projectService;
    protected Project project;
    protected HttpServletRequest request;

    public ProjectModificationRequest(ProjectService projectService, int projectId, HttpServletRequest request) {
